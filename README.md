...
- **Design & Assets:** Adobe Creative Suite • Figma • Canva • DAM • PIM <br>
- **Analytics:** Google Analytics • Content Square • Adobe Analytics • Hotjar <br>
- **Workflow & Dev:** Trello • JIRA • Asana • Workfront • Monday <br>
- **Collaboration Platforms:** Slack • Microsoft Teams • Zoom • Google Meet <br>

---

### 🧩 Freelance Services

- **🌐 Web & CMS:** Web Consultation • CMS Implementation • Web Setup • Responsive & Mobile-Optimised Design • Migration • Technical Deployment • Platform Maintenance <br>
- **🧠 Content:** Asset Management • Content Delivery • SEO-Ready Content • Digital Audit <br>
- **🎨 Design & User Experience:** Design Execution • UI Design Accessibility • Usability Improvements <br>
- **🤝🏾 Collaboration & Project Support:** Project Briefing • Creative Workflow Optimisation • Performance Tracking • Quality Assurance • Stakeholder Management <br>

- **🌐 Web & CMS:** Web Consultation • CMS Implementation • Web Setup • Responsive & Mobile-Optimised Design • Migration • Technical Deployment • Platform Maintenance  

- **🧠 Content:** Asset Management • Content Delivery • SEO-Ready Content • Digital Audit  

- **🎨 Design & User Experience:** Design Execution • UI Design • Accessibility • Usability Improvements  

- **🤝🏾 Collaboration & Project Support:** Project Briefing • Creative Workflow Optimisation • Performance Tracking • Quality Assurance • Stakeholder Management
...
📄 [![CV](https://img.shields.io/badge/View%20My%20CV-PDF-orange?style=flat&logo=adobeacrobatreader&logoColor=white)](./Cosar_CV.pdf)
